...
class AuthLoginTest extends TestCase
{
	...
	protected $provider;
	protected $random_driver;

	public function setUp(): void
	{
		parent::setUp(); // TODO: Change the autogenerated stub

		$this->random_driver = $driver = $this->randomProvider();
		...
		Socialite::shouldReceive('driver')->with($driver)->andReturn($this->provider);
	}
